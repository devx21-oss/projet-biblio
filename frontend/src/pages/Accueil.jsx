    ...
    <div className="min-h-screen flex flex-col justify-between">
      ...
      >
        <div className="bg-black bg-opacity-60 flex-grow flex flex-col items-center justify-center text-white px-6 py-20 text-center">
          ...
          {/* Gestion affichage boutons selon connexion */}
          <div className="flex flex-wrap justify-center gap-6 mb-16">
            {!user ? (
              ...
              <>
                <span className="px-6 py-3 rounded-lg font-semibold shadow-lg bg-green-600">
                  Bienvenue, {user.role} ({user.prenom} {user.nom})
                </span>
                <button
                  onClick={handleLogout}
                  className="bg-red-600 hover:bg-red-700 px-6 py-3 rounded-lg font-semibold shadow-lg transition"
                >
                  Se déconnecter
                </button>
              </>
